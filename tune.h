...
namespace eval
    ...
    class PGNPlayer :
        ...
        virtual void readGameTermination ()
            ...
            all_selected_nodes_.insert(all_selected_nodes_.end(), current_game_nodes_.begin(),
                current_game_nodes_.end());
        ...
        void printProgress (bool force)
            ...
            cout << "game_count_:" << game_count_ << " position_count_:" << all_nodes_count_ << " all_nodes_.size:"
                << all_selected_nodes_.size() << endl;
            }
...
*/
    ...
    double E (const std::vector<Node> & nodes, const std::vector<Param> & params,
