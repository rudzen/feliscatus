...
void initialize_magics(const std::array<MagicInit, 64>& magicInit, MagicTable& magic) {
  ...
  static constexpr std::array<std::array<Direction, 2>, 4> BishopDirections{
    {{SOUTH_WEST, SOUTH_SOUTH_WEST}, {SOUTH_EAST, SOUTH_SOUTH_EAST}, {NORTH_WEST, NORTH_NORTH_WEST}, {NORTH_EAST, NORTH_NORTH_EAST}}
  };
...
void init() {
  ...
  static constexpr std::array<MagicInit, SQ_NB> BishopInit{
    {{0x007bfeffbfeffbff, 16530}, {0x003effbfeffbfe08, 9162},  {0x0000401020200000, 9674},  {0x0000200810000000, 18532}, {0x0000110080000000, 19172}, {0x0000080100800000, 17700}, {0x0007efe0bfff8000, 5730},  {0x00000fb0203fff80, 19661}, {0x00007dff7fdff7fd, 17065}, {0x0000011fdff7efff, 12921},
     {0x0000004010202000, 15683}, {0x0000002008100000, 17764}, {0x0000001100800000, 19684}, {0x0000000801008000, 18724}, {0x000007efe0bfff80, 4108},  {0x000000080f9fffc0, 12936}, {0x0000400080808080, 15747}, {0x0000200040404040, 4066},  {0x0000400080808080, 14359}, {0x0000200200801000, 36039},
     {0x0000240080840000, 20457}, {0x0000080080840080, 43291}, {0x0000040010410040, 5606},  {0x0000020008208020, 9497},  {0x0000804000810100, 15715}, {0x0000402000408080, 13388}, {0x0000804000810100, 5986},  {0x0000404004010200, 11814}, {0x0000404004010040, 92656}, {0x0000101000804400, 9529},
     {0x0000080800104100, 18118}, {0x0000040400082080, 5826},  {0x0000410040008200, 4620},  {0x0000208020004100, 12958}, {0x0000110080040008, 55229}, {0x0000020080080080, 9892},  {0x0000404040040100, 33767}, {0x0000202040008040, 20023}, {0x0000101010002080, 6515},  {0x0000080808001040, 6483},
     {0x0000208200400080, 19622}, {0x0000104100200040, 6274},  {0x0000208200400080, 18404}, {0x0000008840200040, 14226}, {0x0000020040100100, 17990}, {0x007fff80c0280050, 18920}, {0x0000202020200040, 13862}, {0x0000101010100020, 19590}, {0x0007ffdfc17f8000, 5884},  {0x0003ffefe0bfc000, 12946},
     {0x0000000820806000, 5570},  {0x00000003ff004000, 18740}, {0x0000000100202000, 6242},  {0x0000004040802000, 12326}, {0x007ffeffbfeff820, 4156},  {0x003fff7fdff7fc10, 12876}, {0x0003ffdfdfc27f80, 17047}, {0x000003ffefe0bfc0, 17780}, {0x0000000008208060, 2494},  {0x0000000003ff0040, 17716},
  ...
  static constexpr std::array<MagicInit, SQ_NB> RookInit{
    {{0x00a801f7fbfeffff, 85487}, {0x00180012000bffff, 43101}, {0x0040080010004004, 0},     {0x0040040008004002, 49085}, {0x0040020004004001, 93168}, {0x0020008020010202, 78956}, {0x0040004000800100, 60703}, {0x0810020990202010, 64799}, {0x000028020a13fffe, 30640}, {0x003fec008104ffff, 9256},
     {0x00001800043fffe8, 28647}, {0x00001800217fffe8, 10404}, {0x0000200100020020, 63775}, {0x0000200080010020, 14500}, {0x0000300043ffff40, 52819}, {0x000038010843fffd, 2048},  {0x00d00018010bfff8, 52037}, {0x0009000c000efffc, 16435}, {0x0004000801020008, 29104}, {0x0002002004002002, 83439},
     {0x0001002002002001, 86842}, {0x0001001000801040, 27623}, {0x0000004040008001, 26599}, {0x0000802000200040, 89583}, {0x0040200010080010, 7042},  {0x0000080010040010, 84463}, {0x0004010008020008, 82415}, {0x0000020020040020, 95216}, {0x0000010020020020, 35015}, {0x0000008020010020, 10790},
     {0x0000008020200040, 53279}, {0x0000200020004081, 70684}, {0x0040001000200020, 38640}, {0x0000080400100010, 32743}, {0x0004010200080008, 68894}, {0x0000200200200400, 62751}, {0x0000200100200200, 41670}, {0x0000200080200100, 25575}, {0x0000008000404001, 3042},  {0x0000802000200040, 36591},
     {0x00ffffb50c001800, 69918}, {0x007fff98ff7fec00, 9092},  {0x003ffff919400800, 17401}, {0x001ffff01fc03000, 40688}, {0x0000010002002020, 96240}, {0x0000008001002020, 91632}, {0x0003fff673ffa802, 32495}, {0x0001fffe6fff9001, 51133}, {0x00ffffd800140028, 78319}, {0x007fffe87ff7ffec, 12595},
     {0x003fffd800408028, 5152},  {0x001ffff111018010, 32110}, {0x000ffff810280028, 13894}, {0x0007fffeb7ff7fd8, 2546},  {0x0003fffc0c480048, 41052}, {0x0001ffffa2280028, 77676}, {0x00ffffe4ffdfa3ba, 73580}, {0x007ffb7fbfdfeff6, 44947}, {0x003fffbfdfeff7fa, 73565}, {0x001fffeff7fbfc22, 17682},
