...
constexpr std::array<Bitboard, SQ_NB> square_bb{make_bitboard(A1), make_bitboard(B1), make_bitboard(C1), make_bitboard(D1), make_bitboard(E1), make_bitboard(F1), make_bitboard(G1), make_bitboard(H1), make_bitboard(A2), make_bitboard(B2), make_bitboard(C2), make_bitboard(D2), make_bitboard(E2),
                                                make_bitboard(F2), make_bitboard(G2), make_bitboard(H2), make_bitboard(A3), make_bitboard(B3), make_bitboard(C3), make_bitboard(D3), make_bitboard(E3), make_bitboard(F3), make_bitboard(G3), make_bitboard(H3), make_bitboard(A4), make_bitboard(B4),
                                                make_bitboard(C4), make_bitboard(D4), make_bitboard(E4), make_bitboard(F4), make_bitboard(G4), make_bitboard(H4), make_bitboard(A5), make_bitboard(B5), make_bitboard(C5), make_bitboard(D5), make_bitboard(E5), make_bitboard(F5), make_bitboard(G5),
                                                make_bitboard(H5), make_bitboard(A6), make_bitboard(B6), make_bitboard(C6), make_bitboard(D6), make_bitboard(E6), make_bitboard(F6), make_bitboard(G6), make_bitboard(H6), make_bitboard(A7), make_bitboard(B7), make_bitboard(C7), make_bitboard(D7),
                                                make_bitboard(E7), make_bitboard(F7), make_bitboard(G7), make_bitboard(H7), make_bitboard(A8), make_bitboard(B8), make_bitboard(C8), make_bitboard(D8), make_bitboard(E8), make_bitboard(F8), make_bitboard(G8), make_bitboard(H8)};
...
constexpr Bitboard pawn_attacks_bb(const Bitboard b) {
  return C == WHITE ? shift_bb<NORTH_WEST>(b) | shift_bb<NORTH_EAST>(b) : shift_bb<SOUTH_WEST>(b) | shift_bb<SOUTH_EAST>(b);
}
...
inline Bitboard piece_attacks_bb(const PieceType pt, const Square sq, const Bitboard occupied = 0) {
  switch (pt) {
    case BISHOP: return piece_attacks_bb<BISHOP>(sq, occupied);

    case ROOK: return piece_attacks_bb<ROOK>(sq, occupied);

    case QUEEN: return piece_attacks_bb<QUEEN>(sq, occupied);

    case KING: return AllAttacks[KING][sq];

    case KNIGHT: return AllAttacks[KNIGHT][sq];
